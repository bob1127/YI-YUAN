      ...
      >
        ...
        <div className={styles.body}>
          ...
          <div className={styles.description}>
            {" "}
            <div className="absolute hover:opacity-85 duration-500 hover:scale-95 hover:shadow-xl shadow-white w-[110px] sm:w-[170px] sm:h-[170px] h-[110px] lg:w-[200px] lg:h-[200px] left-[10%]  xl:left-[20%] top-[30%] sm:top-[40%] xl:top-10 group  z-50 bg-black opacity-45 border rounded-full ">
              <div className="flex justify-center items-center h-full w-full">
                <button class="group relative inline-flex h-12 w-12 items-center justify-center overflow-hidden rounded-full font-medium text-neutral-200">
            ...
            <button class="group relative h-8  bg-transparent px-4 text-neutral-950">
